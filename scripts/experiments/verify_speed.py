...
sys.modules["invisible_core.attacks.latent_cloak"] = dummy_lc_module
...
sys.modules["invisible_core.critics.qwen_critic"] = dummy_qc_module

dummy_stego_module = MagicMock()
sys.modules["invisible_core.attacks.stego_text"] = dummy_stego_module
